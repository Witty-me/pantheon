...
class Plot(object):
    ...
    def run(self):
        ...
        # pd_path = path.join(self.data_dir, 'pantheon_perf_data.json')
        # with open(pd_path, 'w') as fh:
        #     json.dump(perf_data, fh)

        # stats_path = path.join(self.data_dir, 'pantheon_stats.json')
        # with open(stats_path, 'w') as fh:
        #     json.dump(stats_logs, fh)
